...
set_configvar("STRADEX_DISABLE_ASSERT", 0)
...
add_repositories("project-repo stradex_extern_libs")
if is_plat("windows") then
...
add_subdirs("./stradex_cpp/stradex")
add_subdirs("./stradex_pywrap")
add_subdirs("./stradex_cpp/unit_test")
add_subdirs("./stradex_cpp/demo")
add_subdirs("./stradex_cpp/stradex_server")
