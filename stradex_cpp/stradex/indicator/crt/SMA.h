 ...
 * @ingroup Indicator
 */
Indicator stradex_API SMA(int n = 22, double m = 2.0);
Indicator stradex_API SMA(int, const IndParam& m);
Indicator stradex_API SMA(const IndParam& n, double m = 2.0);
Indicator stradex_API SMA(const IndParam& n, const IndParam& m);
