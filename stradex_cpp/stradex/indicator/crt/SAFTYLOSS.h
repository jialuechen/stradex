 ...
 * @ingroup Indicator
 */
Indicator stradex_API SAFTYLOSS(int n1 = 10, int n2 = 3, double p = 2.0);
Indicator stradex_API SAFTYLOSS(const IndParam& n1, const IndParam& n2, double p = 2.0);
Indicator stradex_API SAFTYLOSS(const IndParam& n1, const IndParam& n2, const IndParam& p);
