 ...
 * @ingroup DataDriver
 */
class stradex_API BaseInfoDriver {
    PARAMETER_SUPPORT
...
stradex_API std::ostream& operator<<(std::ostream&, const BaseInfoDriver&);
stradex_API std::ostream& operator<<(std::ostream&, const BaseInfoDriverPtr&);
