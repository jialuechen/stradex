...
#pragma once
#ifndef stradex_UTILITIES_STEALTASKGROUP_H_
#define stradex_UTILITIES_STEALTASKGROUP_H_
 ...
 * @ingroup TaskGroup
 */
class stradex_API StealTaskGroup {
...
#endif /* stradex_UTILITIES_STEALTASKGROUP_H_ */
