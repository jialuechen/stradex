...
double stradex_API roundEx(double number, int ndigits) {
...
double stradex_API roundUp(double number, int ndigits) {
    double f;
    int i;
    f = 1.0;
    i = abs(ndigits);
...
double stradex_API roundDown(double number, int ndigits) {
    double f;
    int i;
    f = 1.0;
    i = abs(ndigits);
