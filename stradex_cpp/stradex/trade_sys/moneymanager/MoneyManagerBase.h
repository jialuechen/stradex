 ...
 */
class stradex_API MoneyManagerBase : public enable_shared_from_this<MoneyManagerBase> {
    PARAMETER_SUPPORT
...
stradex_API std::ostream& operator<<(std::ostream&, const MoneyManagerBase&);
stradex_API std::ostream& operator<<(std::ostream&, const MoneyManagerPtr&);

} /* namespace stradex */

#if FMT_VERSION >= 90000
template <>
struct fmt::formatter<stradex::MoneyManagerBase> : ostream_formatter {};

template <>
struct fmt::formatter<stradex::MoneyManagerPtr> : ostream_formatter {};
#endif
