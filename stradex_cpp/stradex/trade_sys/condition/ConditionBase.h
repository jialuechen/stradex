 ...
 * @ingroup Condition
 */
class stradex_API ConditionBase : public enable_shared_from_this<ConditionBase> {
    PARAMETER_SUPPORT
...
stradex_API std::ostream& operator<<(std::ostream&, const ConditionPtr&);
stradex_API std::ostream& operator<<(std::ostream&, const ConditionBase&);
...
template <>
struct fmt::formatter<stradex::ConditionBase> : ostream_formatter {};

template <>
struct fmt::formatter<stradex::ConditionPtr> : ostream_formatter {};
#endif
