 ...
 * @ingroup ProfitGoal
 */
class stradex_API ProfitGoalBase : public enable_shared_from_this<ProfitGoalBase> {
    PARAMETER_SUPPORT
...
template <>
struct fmt::formatter<stradex::ProfitGoalBase> : ostream_formatter {};

template <>
struct fmt::formatter<stradex::ProfitGoalPtr> : ostream_formatter {};
#endif
