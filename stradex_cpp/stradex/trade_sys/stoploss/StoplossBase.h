 ...
 * @ingroup Stoploss
 */
class stradex_API StoplossBase : public enable_shared_from_this<StoplossBase> {
    PARAMETER_SUPPORT
...
stradex_API std::ostream& operator<<(std::ostream& os, const StoplossBase&);
stradex_API std::ostream& operator<<(std::ostream& os, const StoplossPtr&);
...
template <>
struct fmt::formatter<stradex::StoplossBase> : ostream_formatter {};

template <>
struct fmt::formatter<stradex::StoplossPtr> : ostream_formatter {};
#endif
