 ...
 * @ingroup Signal
 */
SignalPtr stradex_API SG_Single(const Indicator& ind, int filter_n = 20, double filter_p = 0.1,
 ...
 * @ingroup Signal
 */
SignalPtr stradex_API SG_Single2(const Indicator& ind, int filter_n = 20, double filter_p = 0.1,
                             const string& kpart = "CLOSE");
