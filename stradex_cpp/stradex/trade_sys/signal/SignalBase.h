 ...
 * @ingroup Signal
 */
class stradex_API SignalBase : public enable_shared_from_this<SignalBase> {
    PARAMETER_SUPPORT
...
stradex_API std::ostream& operator<<(std::ostream&, const SignalBase&);
stradex_API std::ostream& operator<<(std::ostream&, const SignalPtr&);
...
template <>
struct fmt::formatter<stradex::SignalBase> : ostream_formatter {};

template <>
struct fmt::formatter<stradex::SignalPtr> : ostream_formatter {};
#endif
