 ...
 * @ingroup Slippage
 */
class stradex_API SlippageBase : public enable_shared_from_this<SlippageBase> {
    PARAMETER_SUPPORT
...
stradex_API std::ostream& operator<<(std::ostream&, const SlippageBase&);
stradex_API std::ostream& operator<<(std::ostream&, const SlippagePtr&);
...
template <>
struct fmt::formatter<stradex::SlippageBase> : ostream_formatter {};

template <>
struct fmt::formatter<stradex::SlippagePtr> : ostream_formatter {};
#endif
