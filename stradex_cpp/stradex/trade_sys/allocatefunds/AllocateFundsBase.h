 ...
 */
class stradex_API AllocateFundsBase : public enable_shared_from_this<AllocateFundsBase> {
    PARAMETER_SUPPORT
...
stradex_API std::ostream& operator<<(std::ostream&, const AllocateFundsBase&);
stradex_API std::ostream& operator<<(std::ostream&, const AFPtr&);
...
template <>
struct fmt::formatter<stradex::AllocateFundsBase> : ostream_formatter {};

template <>
struct fmt::formatter<stradex::AFPtr> : ostream_formatter {};
#endif
