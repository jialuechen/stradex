 ...
 * @ingroup Portfolio
 */
class stradex_API Portfolio : public enable_shared_from_this<Portfolio> {
    PARAMETER_SUPPORT
...
stradex_API std::ostream& operator<<(std::ostream&, const Portfolio&);
stradex_API std::ostream& operator<<(std::ostream&, const PortfolioPtr&);
...
template <>
struct fmt::formatter<stradex::Portfolio> : ostream_formatter {};

template <>
struct fmt::formatter<stradex::PortfolioPtr> : ostream_formatter {};
#endif
