 ...
 * @ingroup OrderBroker
 */
class stradex_API OrderBrokerBase {
    PARAMETER_SUPPORT
...
/** @ingroup OrderBroker */
stradex_API std::ostream& operator<<(std::ostream& os, const OrderBrokerBase&);

/** @ingroup OrderBroker */
stradex_API std::ostream& operator<<(std::ostream& os, const OrderBrokerPtr&);
...
template <>
struct fmt::formatter<stradex::OrderBrokerBase> : ostream_formatter {};

template <>
struct fmt::formatter<stradex::OrderBrokerPtr> : ostream_formatter {};
#endif
