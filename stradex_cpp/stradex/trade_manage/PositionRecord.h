 ...
 */
class stradex_API PositionRecord {
public:
    PositionRecord();
 ...
 * @ingroup TradeManagerClass
 */
stradex_API std::ostream& operator<<(std::ostream&, const PositionRecord&);

bool stradex_API operator==(const PositionRecord& d1, const PositionRecord& d2);

} /* namespace stradex */

#if FMT_VERSION >= 90000
template <>
struct fmt::formatter<stradex::PositionRecord> : ostream_formatter {};
#endif
