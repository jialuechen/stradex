 ...
 */
class stradex_API BorrowRecord {
public:
    BorrowRecord();
...
stradex_API std::ostream& operator<<(std::ostream&, const BorrowRecord&);

} /* namespace stradex */

#if FMT_VERSION >= 90000
template <>
struct fmt::formatter<stradex::BorrowRecord> : ostream_formatter {};
#endif
