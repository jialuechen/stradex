 ...
 * @ingroup TradeCost
 */
class stradex_API TradeCostBase {
    PARAMETER_SUPPORT
...
stradex_API std::ostream& operator<<(std::ostream&, const TradeCostBase&);
stradex_API std::ostream& operator<<(std::ostream&, const TradeCostPtr&);

} /* namespace stradex */

#if FMT_VERSION >= 90000
template <>
struct fmt::formatter<stradex::TradeCostBase> : ostream_formatter {};

template <>
struct fmt::formatter<stradex::TradeCostPtr> : ostream_formatter {};
#endif
