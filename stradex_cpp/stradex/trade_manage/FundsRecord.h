 ...
 * @ingroup TradeManagerClass
 */
stradex_API std::ostream& operator<<(std::ostream&, const FundsRecord&);

bool stradex_API operator==(const FundsRecord& d1, const FundsRecord& d2);

} /* namespace stradex */

#if FMT_VERSION >= 90000
template <>
struct fmt::formatter<stradex::FundsRecord> : ostream_formatter {};
#endif
